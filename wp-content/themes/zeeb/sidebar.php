<div id="sidebar">
      ...
      <!-- comment out or delete the below line if you don't want the tabbed module, or simply delete everything in tabbedmenu.php -->
		...
		<?php include (TEMPLATEPATH . "/tabbedmenu.php"); ?>
		...
		<ul>
			...
			<li><div class="first"><span>Author</span></div>
			<p>A little something about you, the author. Nothing lengthy, just an overview.</p>
			</li>
			-->
<?php wp_list_categories('show_count=1&title_li=<div><span>Categories</span></div>'); ?>
			...
			<li class="chives"><div><span>Archives</span></div>
				<ul>
			...
			<?php /* If this is the frontpage */ if ( is_home() || is_page() ) { ?>
				...
				<li class="metas"><div><span>Meta</span></div>
				<ul>
					<?php wp_register(); ?>
